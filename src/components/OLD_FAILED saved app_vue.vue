...
<template>
  ...
  <FullPageSection>
   ...
   // Add these lines to log destination value
   console.log("destination:", destination);
   console.log("destination.index:", destination.index);
   console.log('Passing destination.index to mapboxMap.vue:', destination.index); // Add this line
        ...
        // Emit the section-changed event and pass the destination.index
        this.$emit("section-changed", destination.index);
