...
export default {
  ...
  computed: {
    shouldShowMtLaurelButton() {
      return this.currentIndex === 4 || this.currentIndex === 5 || this.currentIndex === 6;
    },
    shouldShowMunicipalitiesButton() {
      return this.currentIndex === 5 || this.currentIndex === 6;
    },
